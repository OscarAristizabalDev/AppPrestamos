...
const CalculateLoanQuoteForm = ({
  initialValues = {},
  onSubmit,
  mode = "create",
}: CalculateLoanQuoteProps) => {
  const {
    control,
    handleSubmit,
  ...
  return (
    <View style={styles.container}>
      ...
      />
      {errors.numberQuotes && (
        <Text style={styles.error}>{errors.numberQuotes.message}</Text>
      )}
      ...
      <Button
        title={mode === "edit" ? "Actualizar Prestamo" : "Crear Prestamo"}
